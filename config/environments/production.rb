...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "breadboard_production"

  config.action_mailer.perform_caching = false
  
  config.action_mailer.default_url_options = { host: ENV.fetch('HOST', "#{ENV['HEROKU_APP_NAME']}.herokuapp.com") }
